...
/**
 * Utility class for managing date operations. Provides methods for date
 * calculations, formatting, and retrieving specific date information.
 *
 * Example usage:
 * 
 * String nextFriday = DateManager.getDateBasedOnDayNameForCurrentWeek("Friday",
 * "yyyy-MM-dd"); System.out.println("Next Friday: " + nextFriday);
 */
public class DateManager {
	...
	/**
	 * Gets a Calendar object representing a date that is a specified number of days
	 * in the future.
	 *
	...
	/**
	 * Returns a formatted date string for a date that is a specified number of days
	 * in the future.
	 *
	 * @param daysOut       the number of days to add to the current date.
	...
	/**
	 * Returns a formatted date string for a date that is a specified number of
	...
	/**
	 * Gets the start and end dates of a week that is a specified number of weeks in
	 * the future.
	 *
	 ...
	 * @return the name of the day (e.g., "Monday") or an empty string if an error
	 *         occurs.
	 */
	public static String getDayNameForDate(String dayDate, String format) {
		try {
			...
			LoggerManager.get().error("Error parsing date: {} {}", dayDate, e);
	 ...
	 * @param format  the desired date format (e.g., "yyyy-MM-dd").
	 * @return the formatted date string of the next occurrence of the specified
	 *         day.
	 */
	...
	/**
	 * Calculates and returns the year, month, and date for a specified number of
	 * days in the future.
	 *
	 * @param daysOut the number of days to add to the current date.
	...
	/**
	 * Helper method to format a Calendar object into a string based on the
	 * specified format.
	 *
	...
	/**
	 * Overloaded helper method to format a Calendar object for a specific day of
	 * the week.
	 *
	 * @param calendar  the Calendar object to format.
	 * @param format    the desired date format (e.g., "yyyy-MM-dd").
